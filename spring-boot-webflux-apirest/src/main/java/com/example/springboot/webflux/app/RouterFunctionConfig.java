...
import com.example.springboot.webflux.app.models.handler.ProductoHandler;
...
public class RouterFunctionConfig {
	...
	public RouterFunction<ServerResponse> routes(ProductoHandler handler){
		return route(GET("/api/v2/productos").or(GET("api/v3/productos")), handler::listar)
				...
				.andRoute(POST("api/v2/productos/data/con-foto"), handler::crearConFoto)
				.andRoute(GET("api/v2/productos/buscar/{nombre}"), handler::verPorNombre)
;
	}
